...
public class KuromojiNeologdPlugin extends AbstractPlugin {
	...
	public Collection<Class<? extends Module>> modules() {
		return ImmutableList
				.<Class<? extends Module>> of(KuromojiIndicesAnalysisModule.class);
	}

	public void onModule(AnalysisModule module) {
		module.addCharFilter("kuromoji_neologd_iteration_mark",
				KuromojiIterationMarkCharFilterFactory.class);
		module.addAnalyzer("kuromoji_neologd", KuromojiAnalyzerProvider.class);
		module.addTokenizer("kuromoji_neologd_tokenizer",
				KuromojiTokenizerFactory.class);
		module.addTokenFilter("kuromoji_neologd_baseform",
				KuromojiBaseFormFilterFactory.class);
		module.addTokenFilter("kuromoji_neologd_part_of_speech",
				KuromojiPartOfSpeechFilterFactory.class);
		module.addTokenFilter("kuromoji_neologd_readingform",
				KuromojiReadingFormFilterFactory.class);
		module.addTokenFilter("kuromoji_neologd_stemmer",
				KuromojiKatakanaStemmerFactory.class);
	}
}
